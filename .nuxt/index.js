...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"easysnap","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"My stylish Nuxt.js project"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_apollomodule_6dac7be6 === 'function') {
    await nuxt_plugin_apollomodule_6dac7be6(app.context, inject)
  }
